...
public class Organize {
	...
	public static String topTwenty() throws Exception{
		String re = new String();
		
		
		for(int i = 0; i < 20; i++) {
			String temp = ordered.get(i).get(0) + "\t\t\t" + ordered.get(i).get(1) + "\n";
			re = re.concat(temp);
		}
		return re;
	}
	
	public static String topFifty() throws Exception{
		String re = new String();
	...
	public static String all() throws Exception{
		String re = new String();
